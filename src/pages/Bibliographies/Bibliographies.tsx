        ...
        <table className="min-w-full divide-y divide-gray-200 bg-black shadow overflow-hidden sm:rounded-lg">
          <thead className="bg-black">
            <tr>
              <th
                scope="col"
                className={`px-6 py-3 text-left text-xs font-medium text-[${themeColor}] uppercase tracking-wider`}
              >
                NAME
              </th>
              <th
                scope="col"
                className={`px-6 py-3 text-left text-xs font-medium text-[${themeColor}] uppercase tracking-wider hidden md:table-cell`}
              >
                AUTHOR
              </th>
              <th
